...
class VAE():
    ...
    def buildGraph(self):
        ...
        with tf.variable_scope('encoder'):
            enc_1=nn.conv2d(self.norm_x, 32, 3, stride=2) #out :48
            enc_2=nn.conv2d(enc_1, 32, 3, stride=2) #out:24
        ...
        with tf.variable_scope('decoder'):
            ...
            dec_5=nn.conv2d_transpose(dec_4, 32, 3, 2) #out: 24
            dec_6=nn.conv2d_transpose(dec_5, 32, 3, 2) #out: 48
    ...
    def buildLoss(self):
        ...
        self.totLoss = self.reconstr_loss + self.beta*self.KLLoss
